...
int main(int argc, char* argv[])
{
    ...
    // Test 1: Inverse NTT with RNS (multiple DISTINCT moduli) using X_N_plus
    {
        if (argc < 3)
        {
            LOGN = 12;
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // Execute GPU Inverse NTT with mod_count using X_N_plus
    ...
    // Test 2: NTT -> INTT roundtrip with RNS using X_N_plus
    {
        if (argc < 3)
        {
            LOGN = 12;
