...
// This test verifies GPU NTT with multiple DISTINCT moduli (RNS-style) using
...
int main(int argc, char* argv[])
{
    ...
    // Test 1: Forward NTT with RNS (multiple DISTINCT moduli) using X_N_plus
    {
        if (argc < 3)
        {
            LOGN = 12;
        ...
        cout << "\n=== Testing GPU RNS Forward NTT (X^n + 1) with DISTINCT 61-bit "
                "primes ==="
             << endl;
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // Root of Unity Tables - concatenated for all DISTINCT moduli
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // Execute GPU Forward NTT with mod_count using X_N_plus
        ...
        for (int i = 0; i < total_batch; i++)
        {
            ...
            if (!check)
            {
                cout << "Forward NTT (X^n + 1) FAILED (in poly " << i
            ...
            {
                cout << "All Correct - GPU RNS Forward NTT (X^n + 1) with "
    ...
    // Test 2: Full NTT multiplication roundtrip with RNS using X_N_plus
    {
        if (argc < 3)
        {
            LOGN = 12;
        ...
        cout << "\n=== Testing GPU RNS NTT Multiplication Roundtrip (X^n + 1) ==="
             << endl;
        cout << "MOD_COUNT=" << MOD_COUNT << ", LOGN=" << LOGN
             << ", BATCH=" << BATCH << endl;
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // Forward NTT on both polynomials using X_N_plus
        ...
        for (int i = 0; i < total_batch; i++)
        {
            ...
            {
                int idx = i * N + j;
                poly1_ntt[idx] = OPERATOR<TestDataType>::mult(poly1_ntt[idx],
                                                              poly2_ntt[idx], mod);
            }
        }
        ...
        for (int i = 0; i < total_batch; i++)
        {
            ...
            if (!check)
            {
                cout << "NTT Mult Roundtrip (X^n + 1) FAILED (in poly " << i
                     << ", modulus " << mod_idx << ")" << endl;
                break;
            }
            ...
            if ((i == (total_batch - 1)) && check)
            {
                cout << "All Correct - GPU RNS NTT Multiplication (X^n + 1) with "
                     << MOD_COUNT << " DISTINCT 61-bit moduli." << endl;
            }
        }
